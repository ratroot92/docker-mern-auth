...
const db_Create=require('./mysqlcon');
var db = {};

// db_Create.query('CREATE DATABASE IF NOT EXISTS testall',(function(err){
//     (err)?console.log(err):console.log("database create");
// }));

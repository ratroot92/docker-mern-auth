...
class CPD_Resource_person extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
        data: [{
      ...
      <section  className="backco_white" style={{ fontFamily: 'Arial' }}>
        ...
        <div className="row col_margin">
          ...
          <div className="col-md-7 col_padding intr_mr">
            <h2 className="text-center" style={{ margin: '28px 0px 0px 1px' }}>CPD Resource person</h2>
            <div className="row">
...
export default CPD_Resource_person;
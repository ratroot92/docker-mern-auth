...
class SessionContent extends Component {
  ...
  componentDidMount() {
    ...
    db.ref(`liveCourseSessions/${this.props.id}`)
      .once("value")
      .then(cpsc => {
        if (cpsc.val() != null) {
    ...
    return (
      <div className=" col-md-12 ">
        ...
        <div className="col-md-12 lrp-0">
          <span className="fs-24 notoFont-normal"> Live Sessions </span>
                              ...
                              <React.Fragment>
                                ...
                                >
                                  <span className=" pointer">
                                    {" "}
                                    <img
                                      src={require(`../assets/image/LiveVid.png`)}
                                      alt="team member"
                                      height="20"
                                    />
                                    &nbsp;&nbsp;

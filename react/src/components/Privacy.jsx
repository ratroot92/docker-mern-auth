  ...
  <React.Fragment>
    ...
    <section>
      <div className="about_slider top-fix">
        <h4 className="about-slider-heading regular_font">About Us</h4>
      </div>
      <div className="bg-white">
        <div className="text-center container pt-50 pb-50">
      ...
      <div className="bg-grey">
        <div className="row lrm-0">
          ...
          <div className="col-md-6 p-146">
            <h2>Vision</h2>
            <p>
              Our vision is to become the ultimate online learning platform for
              students and aspiring doctors worldwide. We want to provide
              on-the-go access to quality learning material, and be the epitome
              of online learning for all medical examinations that are
              recognised globally.
            </p>
          </div>
        </div>
      ...
      <div className="bg-white ">
        <div className="row lrm-0">
          <div className="col-md-6 p-146">
            <h2>MISSION</h2>
            <p>
              Our mission is to provide quality learning material, and guidance
              from highly skilled, experience and trained doctors who can assist
              aspiring candidates to achieve the same level of perfection and
              success, sitting in the comfort of their own homes.
            </p>
          </div>
    ...
    <section className="bg-white">
      <div className="default-spacing container">
